...
class ModelSettings(BaseSettings):
    ...
    llm_sell_parser_provider: str = "glm"
    llm_sell_parser_model: str = "glm-4.7"
    llm_sell_parser_timeout_seconds: int = 30
    llm_sell_price_provider: str = "glm"
    llm_sell_price_model: str = "glm-4.7"
    llm_sell_price_timeout_seconds: int = 30
    llm_sell_reply_provider: str = "glm"
    llm_sell_reply_model: str = "glm-4.7"
